...
class FireBaseService{
  ...
  Future getImage(String imgPath) async {
  ...
  Stream<DocumentSnapshot> eventoDescripcion(String id) {
    return _fireStore.collection('eventos').doc(id).snapshots();
  }
